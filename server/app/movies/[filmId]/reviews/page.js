...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 319)), "/home/runner/work/react-hw-05-movies/react-hw-05-movies/src/app/movies/[filmId]/reviews/page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6624)), "/home/runner/work/react-hw-05-movies/react-hw-05-movies/src/app/loading.tsx"],
    ...
    const pages = ["/home/runner/work/react-hw-05-movies/react-hw-05-movies/src/app/movies/[filmId]/reviews/page.tsx"];
    ...
    const originalPathname = "/movies/[filmId]/reviews/page"
...
;// CONCATENATED MODULE: ./src/components/Reviews/Reviews.tsx


const Reviews = async ({ filmId  })=>{
    const information = await (0,servicesFilms/* fetchReviewsFromFilm */.Mx)({
        filmId
    });
    if (!information) {
        return null;
...
;// CONCATENATED MODULE: ./src/app/movies/[filmId]/reviews/page.tsx


function Page({ params: { filmId  }  }) {
    // @ts-expect-error Async Server Component
    return /*#__PURE__*/ jsx_runtime_.jsx(Reviews_Reviews, {
        filmId: filmId
    });
}
